...
<body>
		...
		$(document).ready(function() {
			...
			$('#submitbutton').click(function() {
				if ($('#pw').val().length < 4) {
					...
					alert('Veteran번호를 입력하세요');
					$('#serial_number').focus();
				} else {
					var url = "joincheckId.do?id=" + form.id.value;
					win = window.open(url, "idCheck",
							"width=400, height=400, left=100, top=100");
					$('#form').submit();
				}
	...
	<form name="form" id="form"
		action="${pageContext.request.contextPath}/joinveteran.do" method="post">
		<table class="table">
			<tr>
				<th>ID</th>
				...
				<td><input id="role" name="role" class="form-control"
					type="hidden" value="Veteran" readonly="readonly">
			...
			<tr>
				...
				<td><input id="serial_number" name="serial_number"
					...
					placeholder="Veteran번호를 입력해주세요."></td>
			</tr>
			<tr>
				<th>첨부파일</th>
				<td><script>
		...
		<div align="center">
			<input class="btn btn-success"
				id="submitbutton" type="button" value="가입"> <a
